...
async def test_cast_types_base():
    ...
    assert isinstance(dict_model["some_value_three"], str)
...
async def test_cast_to_string_complex_types_tuple() -> None:
    class TestModel(BaseModel):
        some_value: tuple
...
async def test_cast_to_string_complex_types_set() -> None:
    class TestModel(BaseModel):
        some_value: UUID4
...
async def test_cast_to_string_complex_types_secret_without_deciphering() -> None:
    class TestModel(BaseModel):
...
async def test_cast_to_string_complex_types_secret_with_deciphering() -> None:
    class TestModel(BaseModel):
        some_value: pydantic.SecretStr
        some_value_two: pydantic.SecretBytes
...
async def test_cast_to_string_complex_types_list_with_deciphering() -> None:
    class TestModel(BaseModel):
        some_value: pydantic.SecretStr
...
async def test_cast_to_string_complex_types_dict_with_deciphering():
    class TestModel(BaseModel):
        some_value: pydantic.SecretStr
...
async def test_cast_to_string_complex_types_datatime():
    class TestModel(BaseModel):
...
async def test_cast_to_string_complex_types_datatime_with_deciphering():
    class TestModel(BaseModel):
        some_value: datetime.datetime
...
async def test_model_reduction():
    class TestModel(BaseModel):
        some_value: int
...
async def test_model_reduction_with_deciphering():
    class TestModel(BaseModel):
        some_value: pydantic.SecretStr
